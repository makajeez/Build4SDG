...
const covid19ImpactEstimator = (data) => {
  ...
  const iSevereCasesbyRequestedTime = Math.trunc((iCurrentlyInfected * (2 ** factor)) * 0.15);
  const sSevereCasesbyRequestedTime = Math.trunc((sCurrentlyInfected * (2 ** factor)) * 0.15);
